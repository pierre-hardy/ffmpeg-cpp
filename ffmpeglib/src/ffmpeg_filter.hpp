#ifndef FFMPEG_FILTER_HPP
#define FFMPEG_FILTER_HPP
/*
...
public:
	...
	cmdutils *cmdutils_p;
#define check_stream_specifier cmdutils_p->check_stream_specifier
#define exit_program	cmdutils_p->exit_program

public:
#define static

static const enum AVPixelFormat mjpeg_formats[10] =
        { AV_PIX_FMT_YUVJ420P, AV_PIX_FMT_YUVJ422P, AV_PIX_FMT_YUV420P, AV_PIX_FMT_YUV422P, AV_PIX_FMT_NONE };
static const enum AVPixelFormat ljpeg_formats[10] =
